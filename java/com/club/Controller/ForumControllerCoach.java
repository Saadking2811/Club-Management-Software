...
public class ForumControllerCoach implements Initializable {
...
double poids;
 try {
    ...
    confirmation.setGraphic(imageView);
     ...
     showAlert(Alert.AlertType.ERROR, "Attention !!!", "La taille et le poids du coach doivent être un nombre entier");
 }
 }

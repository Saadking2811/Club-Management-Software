...
public class CaseStaffController {
    ...
    public void setData(Adherent2 adherent2){
        try {
            ...
            nbA.setText(adherent2.getGenre());
...
if (picStream != null) {
    ...
    @FXML
    public void switchToDetailStaff(ActionEvent event) throws IOException, SQLException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("detailStaff.fxml"));
        ...
        detailController.initialiserStaff(this.AdherentID);
    ...
    private void Supprimercard(ActionEvent event) {
            ...
            confirmation.setHeaderText("Voulez-vous vraiment supprimer cet staff ?");
            ...
            if (result.isPresent() && result.get() == ButtonType.OK) {
                try {
                    ...
                    showAlert(Alert.AlertType.INFORMATION, "Confirmation", "Staff supprimé avec succès!");
                    
                    switchToVoirStaff(event);
    ...
    private Parent root;
    @FXML
     public void switchToVoirStaff(Event event) throws IOException{
